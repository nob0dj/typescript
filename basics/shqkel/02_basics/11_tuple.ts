...
let pet4 : PetTuple = ['puma']; 
// let pet5 : PetTuple = [3, 'frog']; // TSError: ⨯ Unable to compile TypeScript:

console.log(pet); // [ 'dog', 5, true ]
console.log(pet2); // [ 'cat', 3, false ]
console.log(pet3); // [ 'cat', 5 ]
console.log(pet4); // [ 'puma' ]
