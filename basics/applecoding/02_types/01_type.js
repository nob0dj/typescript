...
username = 'sinsa';
let code; // union 타입 (2개 이상을 합친 타입)
code = "abc";
code = 1234;
let married = true;
// null 또는 undefined
...
let arr = [1, 'abc']; // 소괄호 필수
// 객체 object
// let obj : object = { name : '홍길동', age : 33};
// 각 속성별로 타입 지정 가능
let obj = { name: '홍길동', age: 33 };
console.log(obj);
